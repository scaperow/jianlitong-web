<template>
  <div class="line">
    ...
    <div v-show="!isShowLabel"  style="display:inline-block" @mouseout="onMouseOut">
      <el-select  @change="onSelectChange" v-model="selectValue" @visible-change="onVisibleChange" @blur="onBlur" :ref="selector" size="small" filterable placeholder="请选择">
        <el-option v-for="item in $option.selection" :key="item.value" :label="item.title" :value="item.value">
        </el-option>
      </el-select>
    </div>
